...
public class DataManager {
    ...
    public static DataManager getInstance() {
        if(ourInstance == null) {
            ...
            // we are nolonger retrieving data from in memory but rather from database
...
//            ourInstance.initializeExampleNotes();
    ...
    public static void loadFromDatabase(NoteKeeperDbOpenHelper dbOpenHelper) {
      // requesting database connection - returns a reference to the SQLiteDatabase
        SQLiteDatabase db = dbOpenHelper.getReadableDatabase();

        // we now need to query the database to retrieve values
    ...
    private static void loadCoursesFromDatabase(Cursor cursor) {
        // we want to get the column values out of the cursor
        // we get those column values based on the column position.
        // we don't want to hard code the positions, we want to request cursor for them
        ...
        DataManager dm = getInstance();
        // clear courses that might have already been loaded
        dm.mCourses.clear();
